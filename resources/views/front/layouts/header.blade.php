                ...
                <div class="row">
                            ...
                            <div class="topbar-left">
                                <ul class="list-inline">
                                    <li> <span class="topbar-label"><i class="fa  fa-home"></i></span> <span
                                            class="topbar-hightlight">Erdemir Cd. No: 142 Kzd. EREĞLİ</span> </li>
                                    <li> <span class="topbar-label"><i class="fa fa-envelope-o"></i></span> <span
                                            class="topbar-hightlight"><a
                                                href="mailto:info@yourdomain.com">niyaziteknik@hotmail.com</a></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 right_section_header_top">
                        ...
                        <div class="float-right">
                            <div class="make_appo"> <a class="btn white_btn" href="make_appointment.html">Bize
                                    Yazın!</a> </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="navbar_menu">
                                <ul class="first-ul">
                                    ...
                                    <li> <a href="it_service.html">Ürünlerİmİz</a>
                                        @foreach($categories ?? '')
                                        <ul>
                                            <li><a href="it_service_list.html">{{ category.name}}</a></li>
                                        </ul>
                                        @endforeach
                                    </li>
                                    <li> <a href="#">Pages</a>
